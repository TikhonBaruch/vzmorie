...
const features = [
  {
    icon: Eye,
    title: "Прозрак",
    description: "Уникальный экологический фактор Каспия — кристально чистая вода на раскатах. Фильтрация камышами даёт видимость до 5 метров. Именно здесь начинается сезон подводной охоты.",
    season: "Апрель — Октябрь",
  },
  {
    icon: Fish,
    title: "Рыба банка",
    description: "Жерех, сом, чехонь, окунь — обитатели Кулагинского банка. Подвохи работают на глубинах 3-8 метров.",
    season: "Круглый год",
  },
  {
    icon: Shield,
    title: "Зимовальные ямы",
    description: "Глубокие ямы 12-15 метров — место концентрации сома и крупной рыбы в холодный сезон.",
    season: "Осень — Весна",
  },
];

const rules = [
  "Нужен паспорт — погранзона, данные за 3 дня до заезда",
